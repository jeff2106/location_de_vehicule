...
import FlatlistFraisTravaux from './FlatlistFraisTravaux'
import { DataNavigation } from 'react-data-navigation';

//Donnee//

export default function FraisTravauxDetail({ route, navigation }) {
    const { Reparation1,
        Reparation2,
        Reparation3,
        Reparation4,
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
          ...
          <View style={styles.body}>
            ...
            <View style={styles.tickethead}>
                  <Text style={{fontSize:18}}>Frais de travaux </Text>
                  <Text style={styles.garageText}>Les frais de travaux prennent en compte l'ensemble de la main d'oeuvre des taches a realisé {"\n"}</Text>
                  <FlatlistFraisTravaux/>
